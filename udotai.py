...
wd_tagger_model_name = "wd-v1-4-convnextv2-tagger-v2.onnx"
wd_tagger_model_path = os.path.join(custom_nodes_directory, 'ComfyUI-WD14-Tagger/models')
download_file(wd_tagger_model_url, wd_tagger_model_name, wd_tagger_model_path)
...
wd_tagger_csv_name = "wd-v1-4-convnextv2-tagger-v2.cvs"
download_file(wd_tagger_csv_url, wd_tagger_csv_name, wd_tagger_model_path)
